...
public class RuleTest {
    ...
    void linearRule() {
        ...
        Assertions.assertThat(linearRule.isStop()).isEqualTo(linearRule.getStopCount() == 1);
    }
    ...
    void randomRule() {
        ...
        Assertions.assertThat(randomRule.isStop()).isEqualTo(randomRule.getStopCount() == 1);
    }
}
